...
export function apiAuthLoginPost$Plain(http: HttpClient, rootUrl: string, params: ApiAuthLoginPost$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<LoginResponse>> {
